...
const tyran = {
  ...
  for(let i = 0; i < graduates.length; i++) {
    let uni = {};
    uni.university = graduates[i].university;
  ...
  for(let i = 0; i < graduates.length; i++) {
    let contact = {};
    contact.first_name = graduates[i].first_name;
    contact.email = graduates[i].email;
  ...
  */
  ...
  for(let i = 0; i < zooAnimals.length; i++) {
    let lowCase = {};
    lowCase.animal_name = zooAnimals[i].animal_name.toLowerCase();
    lowCaseAnimalNames.push(`${lowCase.animal_name}.`);
    lowCase = {};
  }
  // zooAnimals.map((animal_name) => {
  //    lowCaseAnimalNames.push(toLowerCase(`${zooAnimals}.`));
  // })
